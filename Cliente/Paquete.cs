...
namespace Servidor
{
    public class Paquete
    {
         ...
         *Es decir, este método va a transformar un paquete a string de forma implicita como nosotros indicamos
         *Por ejemplo si pasamos el paquete en un metodo(string paquete), al hacer metodo(paquete), siento de
         * tipo Paquete el argumento pasado, este pasará a ser nuestro string convertido.
         */
